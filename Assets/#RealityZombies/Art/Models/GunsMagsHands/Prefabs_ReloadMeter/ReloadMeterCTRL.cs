...
public class ReloadMeterCTRL : MonoBehaviour {
    ...
    public Image Cell_0;
    public float cell0Time=0.1f; 
    public Image Cell_1;
    const float cell1Time=0.2f;
    public Image Cell_2;
    const float cell2Time=0.2f;
    public Text txt;
...
//}
    ...
    private void Update()
    {
        if (GameSettings.Instance.ReloadDifficulty != ARZReloadLevel.EASY && GameSettings.Instance.ReloadDifficulty != ARZReloadLevel.NOOB)
        {
