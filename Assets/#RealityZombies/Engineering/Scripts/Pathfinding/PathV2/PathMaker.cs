...
public class PathMaker : MonoBehaviour {
    ...
    void Start()
    {
        ...
        segmentDistancePF = SegmentSizeMaster; //was GameSettings.Instance.SegmentSizeMaster;
    ...
    IEnumerator GetPath(GameObject startPoint, GameObject targetPoint)
    {
        ...
        if (IsLeanPath)//was if (GameSettings.Instance.IsLeanPath)        CleanPath();
            BuildPAthV3();
    ...
    void CleanPath()
    {
       ...
       // saydirection(firstDirection);
        ...
        if (IsLeanPath)//was if (GameSettings.Instance.IsLeanPath)
    ...
    {
        if (x == 0) { Logger.Debug("going Forward"); }
        else
            if (x == 1) { Logger.Debug("going righ"); }
        else
            if (x == 2) { Logger.Debug("going down"); }
        else
            if (x == 3) { Logger.Debug("going left"); }
