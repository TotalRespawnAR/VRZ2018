...
public class SessionDataManager : MonoBehaviour {
    ...
    private void Start()
    {
       ...
       // Logger.Debug("there are " + info.Length + " files in here");
        ...
        //Logger.Debug(AllSessionsFileName+ " count= " + fileCount + "should only be 1 ");
    }
    ...
    //        Logger.Debug(" saved user" + psess.PInfo.PlayerFirstName + "" + psess.PInfo.PlayerUserName);
