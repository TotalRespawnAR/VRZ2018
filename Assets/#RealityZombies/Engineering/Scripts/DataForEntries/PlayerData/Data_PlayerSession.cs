...
public class Data_PlayerSession  {
    ...
    public Data_PlayerSession(DateTime dt,string  argSessionName, string argSessionVersion, Data_PlayerInfo argPInfo, Data_PlayerPoints argPPoints)
    {
        SerrionTime = SessionTimeStampFormatter(dt);
        SessionName = argSessionName;
        SessionVersion = argSessionVersion;
        PInfo = argPInfo;
        PPoints = argPPoints;
    }

    public Data_PlayerSession(DateTime dt, string argSessionName,bool argIsTournament, string argSessionVersion, Data_PlayerInfo argPInfo, Data_PlayerPoints argPPoints)
    {
        SerrionTime = SessionTimeStampFormatter(dt);
        SessionName = argSessionName;
        IsTournamentMode = argIsTournament;
        SessionVersion = argSessionVersion;
        PInfo = argPInfo;
        PPoints = argPPoints;
    }
