...
public class AirStrike : MonoBehaviour {
 ...
 //           Logger.Debug("Airstrike Start == null");
 //       else
 //           Logger.Debug("Airstrike Start position: " + airstrikeStart.transform.position);

 //       if (airstrikeEnd == null)
 //           Logger.Debug("Airstrike End == null");
 //       else
 //           Logger.Debug("Airstrike End position: " + airstrikeEnd.transform.position);
