...
namespace HoloToolkit.Unity
{
    ...
    public static class MeshSaverOld
    {
        ...
        public static string Save(string fileName, IEnumerable<Mesh> meshes)
        {
            ...
            Logger.Debug(String.Format("Saving mesh file: {0}", Path.Combine(folderName, fileName + fileExtension)));
        ...
        public static IEnumerable<Mesh> Load(string fileName)
        {
            ...
            // Open the mesh file.
            String folderName = MeshFolderName;
            //   Logger.Debug(String.Format("Loading mesh file: {0}", Path.Combine(folderName, fileName + fileExtension)));
