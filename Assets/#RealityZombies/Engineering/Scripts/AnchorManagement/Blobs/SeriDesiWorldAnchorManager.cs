...
namespace HoloToolkit.Sharing
{
    ...
    /// </summary>
    public class SeriDesiWorldAnchorManager : MonoBehaviour // WorldAnchorManager
    {
#if UNITY_WSA
        /// <summary>
        ...
        protected override void AnchorStoreReady(WorldAnchorStore anchorStore)
        {
            ...
            // not doing this now       anchorStore.Clear();
            //}
        }
        ...
        private void RoomManagerListener_OnRoomJoined(Room room, int userId)
        {
            ...
            //{
                ...
                if (ShowDetailedLogs)
                {
                Debug.LogFormat("[SharingWorldAnchorManager] In room {0} with {1} anchors.", "here ", "ancdount?"); 
        ...
        private void RoomManagerListener_AnchorsChanged(Room room)
        {
            ...
            //notsofast buddy
            Debug.Log("NOT SO FAST BUDDY , I WANNA KEEP MY STORE");
           // AnchorStore.Clear();
