...
public class BZplayer2ThirsPersonControl : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        TargetPlayerLoc = GameObject.FindGameObjectWithTag("Player").transform;
        transform.LookAt(new Vector3(TargetPlayerLoc.position.x, this.transform.position.y, TargetPlayerLoc.position.z));
    }
